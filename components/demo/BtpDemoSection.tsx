  ...
  return (
    <section id="demo" className="bg-night px-gutter py-12 md:py-16">
      <div className="mx-auto max-w-content">
        <h2 className="font-heading text-3xl text-text">Voici ce qui change avec Automatex</h2>
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          <MotionDemo
            demoId="appel-manque"
            staticSrc={DEMO_STATIC.appelManque.src}
            ariaLabel="Appel manqué traité par une réponse automatique en 90 secondes"
