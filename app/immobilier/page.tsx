...
export const metadata: Metadata = {
  ...
  description:
    "Automatex répond à vos leads SeLoger et LBC en moins de 90 secondes pendant vos visites. Mandataires IAD, SAFTI, Capifrance en Normandie. Sans engagement, résiliable en 1 mail.",
